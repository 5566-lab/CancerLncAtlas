#!/usr/bin/env python
"""Materialize strict V3.2 integrated-completeness audit r3."""
...
from cc_hhgt.v32.integrated_completeness_strict_r3 import (  # noqa: E402
    materialize_strict_integrated_completeness_audit_r3,
)
...
def main() -> None:
    ...
    result = materialize_strict_integrated_completeness_audit_r3(
        ...
        evaluator_code_path=(
            ROOT / "cc_hhgt/v32/integrated_completeness_strict_r3.py"
        ),

#!/usr/bin/env python
"""Materialize the implementation-level V3.2 strict completeness audit."""
...
from cc_hhgt.v32.integrated_completeness_strict import (  # noqa: E402
    materialize_strict_integrated_completeness_audit,
)
...
def main() -> None:
    ...
    parser.add_argument(
        "--main-app",
        type=Path,
        default=ROOT / "website/backend/app.py",
    )
    parser.add_argument("--output-root", type=Path, required=True)
    args = parser.parse_args()
    result = materialize_strict_integrated_completeness_audit(
